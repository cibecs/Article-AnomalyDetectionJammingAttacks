...
\Title{A Lightweight AI-based Jamming Detection for Drone Networks}

% MDPI internal command: Title for citation in the left column
\TitleCitation{A Lightweight AI-based Jamming Detection for Drone Networks}
...
Our solution is designed to run on a resource constrained device like a drone, and is able to detect both constant and periodic jamming attacks with a high degree of accuracy.
...
Our solution also leverages the Isolation Forest algorithm for jamming detection in the scenario of a 6G drone network, testing the model against the dataset proposed in \cite{JammingDetectionIoT-Hussain}.
