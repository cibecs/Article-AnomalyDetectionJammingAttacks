...
In figure \ref{fig:} we can see a representation of the input signal in the case of a constant jamming attack.

%TODO Add figure of constant jamming attack
...
The first parameter that we decided to tune was the \textit{n\_estimators} parameter. The parameter was varied between 10 and 1000, with a step of 10. The results tuning values are shown in table \ref{tab:n_estimators_tuning}.
