...
Classification times and training times were measured for both models and the results are shown in figures \ref{fig:majority_rule_training_time} and \ref{fig:majority_rule_classification_time}.
